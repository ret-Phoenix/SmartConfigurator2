...
Процедура СоздатьЭлементыФормы()
	...
	ГруппаСочитаниеКлавиш = ЭлементыФормы.Добавить("ГруппаСочитаниеКлавиш", "ГруппаФормы", Неопределено);
	ГруппаСочитаниеКлавиш.Вид = ВидГруппыФормы.ОбычнаяГруппа;
	ГруппаСочитаниеКлавиш.Заголовок = "Сочитание клавиш";
	
	ФлагCtrl = ЭлементыФормы.Добавить("ФлагCtrl", "ПолеФормы", ГруппаСочитаниеКлавиш);
	ФлагCtrl.Заголовок = "Ctrl";
	ФлагCtrl.Вид = ВидыПоляФормы.ПолеФлажка;
	ФлагCtrl.ПоложениеЗаголовка = ПоложениеЗаголовка.Право;
	
	ФлагAlt = ЭлементыФормы.Добавить("ФлагAlt", "ПолеФормы", ГруппаСочитаниеКлавиш);
	ФлагAlt.Заголовок = "Alt";
	ФлагAlt.Вид = ВидыПоляФормы.ПолеФлажка;
	ФлагAlt.ПоложениеЗаголовка = ПоложениеЗаголовка.Право;
	
	ФлагShift = ЭлементыФормы.Добавить("ФлагShift", "ПолеФормы", ГруппаСочитаниеКлавиш);
	ФлагShift.Заголовок = "Shift";
	ФлагShift.Вид = ВидыПоляФормы.ПолеФлажка;
	ФлагShift.ПоложениеЗаголовка = ПоложениеЗаголовка.Право;
	
	ФлагWin = ЭлементыФормы.Добавить("ФлагWin", "ПолеФормы", ГруппаСочитаниеКлавиш);
	ФлагWin.Заголовок = "Win";
	ФлагWin.Вид = ВидыПоляФормы.ПолеФлажка;
	ФлагWin.ПоложениеЗаголовка = ПоложениеЗаголовка.Право;
	
	ПолеКлавиша = ЭлементыФормы.Добавить("ПолеКлавиша", "ПолеФормы", ГруппаСочитаниеКлавиш);
